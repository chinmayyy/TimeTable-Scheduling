...
%Specify epsilon 
e_ij_ex = ones(l,1).* (0.02);
e_ij_inhi = ones(l,1).* (-(0.03));
...
for i = 1:it
    ...
    coupling_ex = e_ij_ex .* ((Pex*spikes_in)>0);
    coupling_inhi = e_ij_inhi .* ((Pinhi*spikes_in)>0);
